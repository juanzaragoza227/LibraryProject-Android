...
public class ATHMovilButtonOriginal extends AppCompatButton {

     CharSequence result;

    public ATHMovilButtonOriginal(Context context) {
        super(context);
        init();
    }

    public ATHMovilButtonOriginal(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ATHMovilButtonOriginal(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        setBackgroundColor(getResources().getColor(R.color.orange_button));
