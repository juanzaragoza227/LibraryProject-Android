...
public class ATHMovilButtonDark extends AppCompatButton {

     CharSequence result;

    public ATHMovilButtonDark(Context context) {
        super(context);
        init();
    }

    public ATHMovilButtonDark(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ATHMovilButtonDark(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        setBackgroundColor(getResources().getColor(R.color.dark_button));
